        ...
        <div class="space-y-4">
          ...
          <template v-if="selectedRole === 'teacher'">
            ...
            <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
              ...
              <div v-if="form.classroom_action === 'new'" class="space-y-3">
                <div>
                  ...
                  <p v-if="form.errors.classroom_number" class="mt-1 text-sm text-red-600 dark:text-red-400">
                    {{ form.errors.classroom_number }}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                  />
                  <p v-if="form.errors.classroom_name" class="mt-1 text-sm text-red-600 dark:text-red-400">
                    {{ form.errors.classroom_name }}
                  </p>
                </div>
              </div>

              <div v-else-if="form.classroom_action === 'existing'">
                ...
                <p v-if="form.errors.classroom_id" class="mt-1 text-sm text-red-600 dark:text-red-400">
          ...
          <template v-if="selectedRole === 'student'">
            ...
            <div>
              ...
              <input
                ...
                class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
              />
              <p v-if="form.errors.cycle" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ form.errors.cycle }}
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
              />
              <p v-if="form.errors.center" class="mt-1 text-sm text-red-600 dark:text-red-400">
                {{ form.errors.center }}
              </p>
            </div>
          </template>
          ...
          <template v-if="selectedRole === 'company'">
            ...
            <div>
              ...
              <input
                ...
                class="mt-1 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
              />
              <p v-if="form.errors.trade_name" class="mt-1 text-sm text-red-600 dark:text-red-400">
